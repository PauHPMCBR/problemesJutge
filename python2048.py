...
class Grid:
    ...
    def generate_empty_grid(self):
        return [[0] * self.sy for i in range(self.sx)]

    def generate_empty_grid2(self):
        return [[0] * self.sx for i in range(self.sy)]
    ...
    def left_compress(self):
        ...
        if len(new_grid) != len(self.cells):
            new_grid = self.generate_empty_grid2()
...
class GamePanel:
    ...
    def __init__(self, grid):
        ...
        self.cell_labels = []
        for i in range(self.grid.sx):
            row_labels = []
            for j in range(self.grid.sy):
